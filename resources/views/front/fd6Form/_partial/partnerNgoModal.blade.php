                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-4 mb-3">
                                ...
                                <input type="text" required name="grants_received_from_abroad" class="form-control" id=""
                                placeholder="পার্টনার এনজিও'র নাম">
                            </div>
                            <div class="col-lg-4 mb-3">
                                <label for="" class="form-label">পার্টনার এনজিও'র ঠিকানা <span class="text-danger">*</span></label>
                                <input type="text" required name="donations_made_by_foreign_donors" class="form-control" id=""
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                type = "number"
                                maxlength = "11" data-parsley-required minlength="11"  data-parsley-trigger=“keyup” required name="donations_made_by_foreign_donors" class="form-control" id=""
                                placeholder="পার্টনার এনজিও'র মোবাইল">
                            </div>

                            <div class="col-lg-6 mb-3">
                                <label for="" class="form-label">পার্টনার এনজিও'র ইমেইল <span class="text-danger">*</span></label>
                                <input type="email" required name="donations_made_by_foreign_donors" class="form-control" id=""
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <textarea required name="donations_made_by_foreign_donors" class="form-control summernote" id=""
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 mb-3">
                                ...
                                <input type="text" required name="ward_name" class="form-control" id="ward_name0"
                                placeholder="বাজেট">
                            </div>
                        ...
                        <a id="expectedResultPost"  class="btn btn-registration">জমা দিন</a>
                    </div>
                </div>
