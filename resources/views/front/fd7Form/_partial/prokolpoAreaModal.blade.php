                            ...
                            <div class="row">
                                ...
                                <select required name="division_name" class="form-control division_name" id="division_name0">
                                    ...
                                    <div class="col-lg-3 mb-3">
                                        ...
                                        <select required name="upozila_name" class="form-control upozila_name" id="upozila_name0">
                                    ...
                                    <div class="col-lg-3 mb-3">
                                        ...
                                        <select required name="thana_name" class="form-control thana_name" id="thana_name0">
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        ...
                                        <select  required name="prokolpoType" class="form-control " id="prokolpoType0"
                                               placeholder="">
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        ...
                                        <input type="text" required name="allocated_budget" class="form-control" id="allocated_budget0" placeholder="">
                                    </div>
                                    <div class="col-lg-4 mb-3">
                                        <label for="" class="form-label">মোট উপকারভোগীর সংখ্যা<span class="text-danger">*</span></label>
                                        <input type="text" required name="beneficiaries_total" class="form-control" id="beneficiaries_total0" placeholder="">
                                    </div>
