...
<tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3"><textarea name="sign_in_closing_report" class="form-control mt-1 summernote" id=""
                                                         required>
                                                        </textarea>

                                                        <input type="file" name="ngo_prokolpo_end_date" class="form-control mt-3" id="ngo_prokolpo_end_date"
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        ...
                                                        <textarea name="sign_in_closing_report" class="form-control mt-1 summernote" id=""
                                                         required>
                                                        </textarea>
